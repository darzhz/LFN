...
<div id="container">
  <div id="main">
    <main>
      ...
      {#if showAdd}
        <Add
          on:close={() => {
            toggle["showAdd"] = false;
            toggle["showMap"] = true;
          }}
          on:loginrequired={() => handleViewChange("showAcc")}
          lat={mylat}
          long={mylong}
        />
      {/if}
  ...
  <div id="navi">
    <div class="content">
      <ul>
        <li>
          <a href="#" on:click={() => handleViewChange("showChat")}>
            <span class="material-symbols-rounded">forum</span>
          </a>
        </li>
        <li>
          <a href="#" on:click={() => handleViewChange("feed")}>
            <span class="material-symbols-rounded">explore</span>
          </a>
        </li>
        <li>
          <a href="#" on:click={() => handleViewChange("showAdd")}>
            <span class="material-symbols-rounded">add_circle</span>
          </a>
        </li>
        <li>
          <a href="#" on:click={() => handleViewChange("showMap")}>
            <span class="material-symbols-rounded">home_pin</span>
          </a>
        </li>
        <li>
          <a href="#" on:click={() => handleViewChange("showAcc")}>
